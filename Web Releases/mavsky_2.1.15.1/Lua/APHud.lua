...
--  useCurrentMonitoring = 1 for current and current consumed
--  useCurrentMonitoring = 2 for current and battery percentage remaining 
--
local useCurrentMonitoring = 2
--
--  vehicleIsPlane = 0 for copter
--  vehicleIsPlane = 1 for plane
--
local vehicleIsPlane = 1
--
-------------------------------------------------------------------------------------------------------------------------------------    
--
...
local function drawFuelRemaining(x, y)
  local fuelRemaining = extensionValue["batt_remain"]
  lcd.drawText(x, y + 5, "Fuel", SMLSIZE)
  lcd.drawNumber(x+43, y, fuelRemaining, MIDSIZE)
  local t = lcd.getLastPos() + 1
  lcd.drawText(t, y + 5, "%", SMLSIZE)
end
...
local function run(event)
  ...
  elseif useCurrentMonitoring == 2 then
      drawCurrent(1, 26)
      drawFuelRemaining(1, 40)
  else
