...
*/
#include "MavlinkToPassthruPlus.h"


// ******************************************
void MavlinkToPassthruPlus::setup()  {
...
// ******************************************
// ******************************************
void MavlinkToPassthruPlus::loop()  {
...
void MavlinkToPassthruPlus::QueueAvailableMavFrames() {
...
//*******************************************
void MavlinkToPassthruPlus::DecodeOneMavFrame() {
...
//***************************************************
void MavlinkToPassthruPlus::MarkHome()  {
  homGood = true;
...
//***************************************************
 void MavlinkToPassthruPlus::Request_Param_Read(int16_t param_index) {
...
//***************************************************
 void MavlinkToPassthruPlus::Request_Param_List() {
...
void MavlinkToPassthruPlus::RequestMission(uint16_t ms_seq) {    //  #40
  ap_sysid = 0xFF;
  ap_compid = 0xBE;
  ap_targsys = 1;
  ap_targcomp = 1; 
...
//***************************************************
#if defined Request_Missions_From_FC || defined Request_Mission_Count_From_FC
void MavlinkToPassthruPlus::RequestMissionList() {   // #43   get back #44 Mission_Count
  ap_sysid = 0xFF;
  ap_compid = 0xBE;
  ap_targsys = 1;
  ap_targcomp = 1; 
...
//***************************************************
#ifdef Request_Missions_From_FC
void MavlinkToPassthruPlus::RequestAllWaypoints(uint16_t ms_count) {
...
//***************************************************
#ifdef Data_Streams_Enabled    
void MavlinkToPassthruPlus::RequestDataStreams() {    //  REQUEST_DATA_STREAM ( #66 ) DEPRECATED. USE SRx, SET_MESSAGE_INTERVAL INSTEAD
...
void MavlinkToPassthruPlus::Aux_ReceiveAndForward() {   // up to FC, optional
...
//***************************************************
void MavlinkToPassthruPlus::ServiceStatusLeds() {
  ServiceMavStatusLed();
  ServiceBufStatusLed();
}
void MavlinkToPassthruPlus::ServiceMavStatusLed() {
  if (mavGood) {
      MavLedState = HIGH;
...
void MavlinkToPassthruPlus::ServiceBufStatusLed() {
  if (MsgRingBuff.isFull()) {
      BufLedState = HIGH;
  }
    else 
...
void MavlinkToPassthruPlus::BlinkMavLed(uint32_t period) {
...
//***************************************************
void MavlinkToPassthruPlus::DisplayByte(byte b) {
...
void MavlinkToPassthruPlus::PrintMavBuffer (const void *object){
...
/*
    ...
    bytes[2] = msg.magic   
    bytes[3] = msg.lth  
    bytes[4] = msg.incompat_flags;          // mav2
    bytes[5] = msg.compat_flags;            // mav2
    bytes[6] = msg.seq;
    bytes[7] = msg.sysid;
    bytes[8] = msg.compid;
    bytes[9] = msg.msgid & 0xFF;
    bytes[10] = (msg.msgid >> 8) & 0xFF;    // mav2
    bytes[11] = (msg.msgid >> 16) & 0xFF;   // mav2
 */
  if (mav1) 
    Debug.print("MAVLink 1: ");
  else
    Debug.print("MAVLink 2: ");
  ...
  Debug.print("//");    
  b= bytes[3];
  lth=b + 2 + 10;                  // total length  = payload length + crc + header
  Debug.print("lth=");             // payload lth
  Debug.print(b);
  Debug.print("//"); 

  if (mav2) {
    b= bytes[4];
    Debug.print("incompat_flags=");
    Debug.print(b);
    Debug.print("//");
    b= bytes[5];
    Debug.print("compat_flags=");
    Debug.print(b);
    Debug.print("//");  
  }
  ...
  mav2_msgid = (bytes[11] << 16) | (bytes[10] << 8) | bytes[9];
  Debug.print("msgid=#");
  Debug.print(mav2_msgid);
  Debug.print(" (0x");
  b= bytes[9];
  if (b<=0xf) Debug.print("0");
  Debug.print(b,HEX);
  ...
  for ( int i = 2; i < lth; i++ ) {
    DisplayByte(bytes[i]);
    if(i==11) Debug.print("  ");      // Print space after header
  }
  Debug.println("//");
  Debug.println();
}
//***************************************************
//***************************************************
float MavlinkToPassthruPlus::RadToDeg (float _Rad) {
  return _Rad * 180 / PI;  
}
//***************************************************
float MavlinkToPassthruPlus::DegToRad (float _Deg) {
  return _Deg * PI / 180;  
}
//***************************************************
String MavlinkToPassthruPlus::MavSeverity(uint8_t sev) {
 switch(sev) {
...
//***************************************************
String MavlinkToPassthruPlus::PX4FlightModeName(uint8_t main, uint8_t sub) {
 switch(main) {
...
//***************************************************
uint8_t MavlinkToPassthruPlus::PX4FlightModeNum(uint8_t main, uint8_t sub) {
 switch(main) {
...
//***************************************************
void MavlinkToPassthruPlus::ShowPeriod() {
