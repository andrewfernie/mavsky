...
//NAV    uint8_t nav_sensor_state = 0;
    ...
    uint32_t aspd = 0;
//NAV     uint32_t nav = 0;
//NAV     uint32_t nav_wpnum = 0;
//NAV     uint32_t nav_wpdist = 0;
//NAV     int32_t  nav_wpbrg = 0;
...
//NAV     void(*nav_data_request_function)(uint32_t *wpnum, uint32_t *wpdist, int32_t *wpbrg ) = NULL;
...
//NAV     void set_nav_request_callback(void(*callback)(uint32_t *wpnum, uint32_t *wpdist, int32_t *wpbrg));
